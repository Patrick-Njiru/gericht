      ...
      <div className='about-us__content flex__center'>
        <div className='about-us__about'>
          ...
          <p className='p__opensans'> 
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quae dicta consectetur incidunt nobis atque eum 
          </p>
        ...
        <div className='about-us__history'>
          ...
          <img src={images.spoon} alt='about__spoon' className='spoon__image' />
          <p className='p__opensans'> 
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quae dicta consectetur incidunt nobis atque 
          </p>
          <button type='button' className='custom__button'> Know More </button>
        </div>
